...
3. They modified the population risk $E_d [L]$ instead of feeding loss L with samples from original D distribution, they perturb the inputs. In this paper, they only focused on $l_{\infinity}$ bounded attacks.
